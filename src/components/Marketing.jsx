                ...
                <div className="deals w-[100%] px-[20px] pt-[10px] md:pt-[20px]">
                    ...
                    <div className="product_list flex items-center justify-between gap-[10px] md:gap-[15px] lg:gap-[20px]">
                        <div className="flex flex-col items-center justify-center gap-[10px] w-[100%] lg:h-[270px] ">
                            <img className='w-[100%] h-[100%]' src="src\assets\marketing_1.png" alt="" />
                            <h1 className='text-[10px] md:text-[14px] lg:text-[16px] text-[#000] font-semibold'>Business Cards</h1>
                        ...
                        <div className="flex flex-col items-center justify-center gap-[10px] w-[100%] lg:h-[270px] ">
                            <img className='w-[100%] h-[100%]' src="src\assets\marketing_2.png" alt="" />
                            <h1 className='text-[10px] md:text-[14px] lg:text-[16px] text-[#000] font-semibold'>Presentation</h1>
                            <div className='flex ga-[5px] md:gap-[10px]'>
                                <p className='text-[#A8A8A8] text-[10px] md:text-[8px] lg:text-[14px]'>Starting at:</p>
                        ...
                        <div className="flex flex-col items-center justify-center gap-[10px] w-[100%] lg:h-[270px] ">
                            <img className='w-[100%] h-[100%]' src="src\assets\marketing_3.png" alt="" />
                            <h1 className='text-[10px] md:text-[14px] lg:text-[16px] text-[#000] font-semibold'>Brochures</h1>
                            <div className='flex ga-[5px] md:gap-[10px]'>
                                <p className='text-[#A8A8A8] text-[10px] md:text-[8px] lg:text-[14px]'>Starting at:</p>
                        ...
                        <div className="flex flex-col items-center justify-center gap-[10px] w-[100%] lg:h-[270px] ">
                            <img className='w-[100%] h-[100%]' src="src\assets\marketing_4.png" alt="" />
                        ...
                        <div className="flex flex-col items-center justify-center gap-[10px] w-[100%] lg:h-[270px] ">
                            <img className='w-[100%] h-[100%]' src="src\assets\marketing_5.png" alt="" />
                            <h1 className='text-[10px] md:text-[14px] lg:text-[16px] text-[#000] font-semibold'>Note Pads</h1>
                            <div className='flex ga-[5px] md:gap-[10px]'>
                                <p className='text-[#A8A8A8] text-[10px] md:text-[8px] lg:text-[14px]'>Starting at:</p>
